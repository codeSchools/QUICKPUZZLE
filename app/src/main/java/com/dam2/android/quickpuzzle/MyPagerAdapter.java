...
public class MyPagerAdapter extends FragmentPagerAdapter implements ViewPager.PageTransformer {
    ...
    public MyPagerAdapter(GalleryActivity context, FragmentManager fm) {
        super(fm);
        this.fm = fm;
    ...
    public Fragment getItem(int position) {
        ...
        position = position % GalleryActivity.PAGES;
        return GalleryFragment.newInstance(context, position, scale);
    }

    @Override
    public int getCount() {
        return GalleryActivity.PAGES * GalleryActivity.LOOPS;
    }
